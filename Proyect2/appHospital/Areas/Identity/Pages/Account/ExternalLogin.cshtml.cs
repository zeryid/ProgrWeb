...
namespace appHospital.Areas.Identity.Pages.Account
{
    ...
    public class ExternalLoginModel : PageModel
    {
        ...
        public ExternalLoginModel(
            SignInManager<appHospital.Models.Usuario> signInManager,
            UserManager<appHospital.Models.Usuario> userManager,
            IUserStore<appHospital.Models.Usuario> userStore,
        ...
        private appHospital.Models.Usuario CreateUser()
        {
            ...
            {
                throw new InvalidOperationException($"Can't create an instance of '{nameof(appHospital.Models.Usuario)}'. " +
                    $"Ensure that '{nameof(appHospital.Models.Usuario)}' is not an abstract class and has a parameterless constructor, or alternatively " +
